...
htmlhelp_basename = 'urwidtreesdoc'
...
latex_documents = [
  ('index', 'urwidtrees.tex', u'urwidtrees Documentation',
...
man_pages = [
    ('index', 'urwidtrees', u'urwidtrees Documentation',
     [u'Patrick Totzke'], 1)
]
...
texinfo_documents = [
  ('index', 'urwidtrees', u'urwidtrees Documentation',
   u'Patrick Totzke', 'urwidtrees', 'One line description of project.',
   'Miscellaneous'),
]
